-- =====================================================
-- VEA DASHBOARD - COMPLETE DATABASE SETUP
...
-- Organizations table (MUST BE FIRST - other tables reference this)
...
-- =====================================================
-- DOCUMENTS TABLES (WITH CORRECT UUID TYPES)
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '📊 Total: 28 tables created';
  RAISE NOTICE 'Next steps:';
  RAISE NOTICE '1. Run the RLS policies migration (002_rls_policies.sql)';
  RAISE NOTICE '2. Run the functions & triggers migration (003_functions_and_triggers.sql)';
END $$;
