...
CREATE TABLE IF NOT EXISTS cash_flow_entries (
  ...
  payment_method TEXT,
  reference_id UUID, -- Can link to invoice_id or expense_id
...
CREATE INDEX idx_cash_flow_organization_id ON cash_flow_entries(organization_id);
...
-- Analytics metrics (pre-aggregated data)
